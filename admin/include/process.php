    ...
    $cuser = new auth();
            ...
            if($_POST["username"]=="" or $_POST["password"]==""){
                echo "<center><h1>User Name , Email and Password Cannot be Empty...!</h1></center>";
                    ...
                    $cuser->login_user($username,$password);
                }
            }
...
// Register User Code
        ...
        if(isset($_POST['register']))
        {
            ...
            $result = $cuser->registeruser($name, $username, $email, $address, $city, $country, $phone, $password);
            ...
            if(isset($_POST['update_location']))
                {
                  ...
                  if(isset($_GET['l_id']))
                  {
                    ...
                    if (isset($_GET['cart_id'])) {
                        $delete_cart = $_GET['cart_id'];
                        $result = $cuser->delteCartData($delete_cart);
                        if ($result) {
