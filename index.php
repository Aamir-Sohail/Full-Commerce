<?php
 ...
 $fetch_last = $product->products_last_three();
?>
<style>
	#clock {
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="admin/uploads/<?php echo $my_images[0];?>" alt="img">
							</div>
							<div class="shop-body">
								<h3><?php echo $f['p_name']?></h3>
								<a href="product.php?p_id=<?php echo $f['id']?>" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<?php }?>
						...
						<div class="row mb-5">
							...
							<div class="product">
									<div class="product-img">
										<img width="100px" height="200px" src="admin/uploads/<?php echo $new_images[0]?>" alt="">
